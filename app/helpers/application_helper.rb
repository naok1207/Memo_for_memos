module ApplicationHelper
  ...
  def ogp_url(text)
    "https://res.cloudinary.com/#{Settings.cloudinary.cloud_name}/image/upload/l_text:Sawarabi%20Gothic_60:#{text},co_rgb:000,w_400,c_fit/v1626790569/ogp_plukpo.png"
  end
